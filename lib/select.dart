...
class _mySearch extends State<Search> {
  ...
  /*void dataValidate() {
    if (formkey.currentState.validate()) {
      ...
      if (_typing) {
        Student search = Student(currentUserId, name, app, appP, telef, correo, matricula);
        setState(() {
          _typing = false;
        });
      } else {
        Student search = Student(null, name, app, appP, telef, correo, matricula);
        dbHelper.query(search);
      }
      refreshList();
    }
  }*/
